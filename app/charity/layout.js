    ...
    <CharityLayoutContext.Provider value={{ openNewCampaign: (animalName) => { setPreselectedAnimal(animalName || null); setShowNewOpening(true); } }}>
      ...
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[1.75rem] border border-white/15 shadow-2xl flex h-[calc(100dvh-12px)] md:h-[calc(100dvh-32px)]">
        ...
        <aside className="hidden lg:flex w-56 shrink-0 flex-col overflow-hidden" style={{ backgroundColor: "#301586" }}>
          {/* Back button — in flow, flush top, no top radius */}
          <Link href="/" className="flex items-center justify-center gap-1.5 shrink-0 text-[11px] font-bold hover:opacity-90 active:scale-[.98] transition-all"
          ...
          {/* Logo with gap below button */}
          <div className="flex justify-center pb-4" style={{ marginTop: 18 }}>
          ...
          <div className="flex items-center justify-between gap-2 px-3 md:px-6 border-b border-purple-900/20 shrink-0"
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <Link href="/" className="lg:hidden inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-lg text-[11px] font-medium shrink-0 hover:opacity-80 active:scale-95 transition-all"
                style={{ color:"#fff", border:"none", background:"#e02020", letterSpacing:"0.02em" }}>
