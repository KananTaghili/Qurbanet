      ...
      <div className="flex h-screen overflow-hidden bg-[#f7f5ff]">
        ...
        <aside className="hidden lg:flex w-56 h-screen flex-col shrink-0 overflow-hidden" style={{ backgroundColor: "#301586" }}>
          ...
          <div className="px-5 pb-4">
            <div className="relative block" style={{ width: 170 }}>
              ...
              <Image src="/mb_logo_bottom_slogan.png" alt="MeatBox" width={170} height={93}
                style={{ width: 170, height: "auto", objectFit: "contain" }} priority />
            </div>
          </div>
