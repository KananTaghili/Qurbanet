  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#fbfaff] px-4 py-2 pb-20 lg:pb-3">
      <div className="mb-3">
        ...
        <p className="mt-0.5 text-[13px] font-semibold text-[#8778a8]">Kollektiv platformasında qurban prosesi</p>
      </div>
        ...
        <div className="space-y-2.5">
          {NECE_STEPS.map((s, i) => (
            <div key={i} className="flex gap-3 relative">
              ...
              <div className="flex-1 rounded-2xl border border-[#ece6f5] bg-white px-4 py-3 shadow-[0_3px_10px_rgba(46,23,92,0.06)]">
                <div className="mb-1 inline-flex items-center justify-center rounded-full bg-[#f1ecff] h-6 w-6">
                  <span className="text-[11px] font-black text-[#5b22c7]">{i + 1}</span>
                </div>
                <div className="text-[14px] font-extrabold leading-snug text-[#241a4d] mb-1">{s.title}</div>
      ...
      <div className="mt-3 rounded-2xl border border-[#e7e1f0] bg-white px-5 py-3 shadow-sm">
