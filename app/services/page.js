...
const cards = [
  ...
  { title: "Ət Satışı",          text: "Təzə və keyfiyyətli ət məhsullarını onlayn sifariş edin, soyudulmuş şəkildə qapınıza çatdıraq.",             color: "orange",  Icon: Beef,           href: "/meat" },
];
...
const colorMap = {
  ...
  orange:  { text: "text-[#f97316]", border: "border-[#f97316]", borderCard: "border-[#f97316]/25", bg: "bg-[#f97316]", bgDot: "bg-[#f97316]" },
};
