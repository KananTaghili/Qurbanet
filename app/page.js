...
const cards = [
  ...
  { title: "Ət Satışı",            text: "Təzə və keyfiyyətli ət məhsullarını onlayn sifariş edin, soyudulmuş şəkildə qapınıza çatdıraq.",             color: "orange",  Icon: Beef,           button: "MƏHSULLARA BAX", href: "/meat",    videoUrl: "https://www.youtube.com/embed/7JRzuVPT5zU?autoplay=1", videoType: "youtube" },
];
...
const colorMap = {
  ...
  orange:  { text: "text-[#f97316]", border: "border-[#f97316]/25", bg: "bg-[#f97316]" },
};
