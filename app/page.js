        ...
        const inner = (
          <div key={s.id} className="relative rounded-2xl shadow-md overflow-hidden bg-black" style={{ height: 320 }}>
            ...
            <div className="absolute inset-0 z-10" style={{
              background: "linear-gradient(to right, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.95) 55%, rgba(255,255,255,0.15) 62%, rgba(255,255,255,0) 66%)",
            }} />

            {/* Text — left side */}
            <div className="absolute inset-y-0 left-0 z-20 flex flex-col justify-between p-5 w-[57%]">
              <div>
