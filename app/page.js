  ...
  return (
    <main className="hp-main bg-background p-1.5 font-sans text-foreground md:p-4" style={{ height: '100dvh', overflow: 'hidden' }}>
      <style>{`
        ...
        .hp-scroll::-webkit-scrollbar-track { background: #111; border-radius: 999px; margin: 8px 0 36px 0; }
      ...
      <section className="mx-auto max-w-7xl overflow-hidden rounded-[1.75rem] border border-white/15 bg-[#130807] shadow-2xl flex flex-col h-[calc(100dvh-12px)] md:h-[calc(100dvh-32px)]">
        ...
        <div className="hp-hero relative overflow-hidden bg-[#190908] px-6 pb-11 pt-4 md:px-12 md:pb-14 md:pt-5">
          <Image src="/home_page_foto_hero_2.png" alt="Hero fon" fill style={{ objectFit: "cover", objectPosition: "center calc(70% + 40px)" }} priority />
