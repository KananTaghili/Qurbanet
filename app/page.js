        ...
        const inner = (
          <div key={s.id} className="relative rounded-2xl shadow-md overflow-hidden bg-black" style={{ height: 320 }}>
            ...
            <div className="absolute inset-0 z-10" style={{
              background: "linear-gradient(to right, rgba(255,255,255,0.92) 0%, rgba(255,255,255,0.85) 30%, rgba(255,255,255,0.4) 50%, rgba(255,255,255,0) 62%)",
            }} />
  ...
  return (
    <section className="relative h-[300px] md:h-[340px] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0" style={{
        background: "radial-gradient(ellipse 60% 90% at 50% 62%, rgba(255,255,255,0.65) 0%, rgba(255,255,255,0.52) 22%, rgba(255,255,255,0.28) 45%, rgba(255,255,255,0.06) 65%, rgba(255,255,255,0) 80%)",
      }} />
      {/* Bottom white fade */}
      <div className="absolute inset-0" style={{
