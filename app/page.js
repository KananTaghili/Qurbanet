  ...
  return (
    <section className="relative h-[300px] md:h-[340px] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0" style={{
        background: "radial-gradient(ellipse 60% 90% at 50% 62%, rgba(255,255,255,0.82) 0%, rgba(255,255,255,0.72) 22%, rgba(255,255,255,0.45) 45%, rgba(255,255,255,0.12) 65%, rgba(255,255,255,0) 80%)",
      }} />
      {/* Bottom white fade */}
      <div className="absolute inset-0" style={{
