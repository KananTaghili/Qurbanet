  ...
  return (
    <section className="relative h-[300px] md:h-[340px] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0" style={{
        background: "radial-gradient(ellipse 48% 72% at 50% 55%, rgba(255,255,255,0.93) 0%, rgba(255,255,255,0.93) 48%, rgba(255,255,255,0.3) 60%, rgba(255,255,255,0) 72%)",
      }} />
      {/* Bottom white fade */}
      <div className="absolute inset-0" style={{
        background: "linear-gradient(to bottom, transparent 82%, rgba(255,255,255,0.8) 92%, #ffffff 100%)",
      }} />
