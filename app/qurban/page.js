  ...
  return (
    <section className={`relative overflow-hidden rounded-2xl bg-[#e9f1eb] shadow-sm ${isMobile ? "px-4 py-3.5" : "px-5 py-3.5 lg:px-6 lg:py-4"}`}>
      ...
      <img
        ...
        className="absolute bottom-0 right-0 hidden lg:block" style={{ height: "120%", width: "auto" }}
      />
      {/* Mobile image */}
      <img
      ...
      />
      {/* Desktop gradient */}
      <div className="absolute inset-0 hidden lg:block" style={{ background: "linear-gradient(to right, #edf5ef 0%, #edf5ef 30%, rgba(237,245,239,0.93) 44%, rgba(237,245,239,0.65) 56%, rgba(237,245,239,0.25) 68%, rgba(237,245,239,0.05) 80%, transparent 100%)" }} />
      {/* Mobile gradient */}
