  ...
  return (
    <section className={`relative overflow-hidden rounded-2xl bg-[#e9f1eb] shadow-sm ${isMobile ? "px-4 py-3.5" : "px-5 py-3.5 lg:px-6 lg:py-4"}`}>
      ...
      <img
        ...
        className="absolute inset-y-0 right-0 h-full w-[72%] object-cover object-center hidden lg:block"
      />
      {/* Mobile image */}
      <img
      ...
      />
      {/* Desktop gradient */}
      <div className="absolute inset-0 hidden lg:block" style={{ background: "linear-gradient(to right, #edf5ef 0%, #edf5ef 28%, rgba(237,245,239,0.88) 42%, rgba(237,245,239,0.4) 58%, rgba(237,245,239,0.05) 75%, transparent 100%)" }} />
      {/* Mobile gradient */}
