  ...
  return (
      ...
      style={
        !isMobile
          ? {
              ...
              backgroundPosition: "left center, right calc(50% + 60px)",
    ...
    >
      ...
      <img
        ...
        className="absolute inset-y-0 right-0 h-full w-[55%] object-cover block lg:hidden"
        style={{ objectPosition: "right calc(50% + 60px)" }}
      />
      {/* Mobile gradient */}
      <div
