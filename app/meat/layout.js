        ...
        >
          ...
          <div className="flex justify-center pb-4" style={{ paddingTop: 46 }}>
            <Link href="/meat" className="relative block" style={{ width: 160 }}>
              <div className="absolute -top-3 -right-3 z-10 grid h-11 w-11 place-items-center rounded-full border-2 border-[#c85a13]/30 bg-white shadow-lg">
                <Beef className="h-7 w-7 text-[#c85a13]" />
              </div>
              <Image
            ...
            {nav.map(({ icon: Icon, label, href }) => {
              ...
              return guestBlock ? (
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-[13px] transition-all text-orange-100/70 hover:bg-white/5 hover:text-white"
                >
                  <Icon size={15} className="text-orange-200/60" />
                  {label}
                </button>
              ) : (
                <Link
                ...
                >
                  <Icon size={15} className={isActive(href) ? "text-white" : "text-orange-200/60"} />
                  {label}
                </Link>
              );
            })}
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          >
            ...
            <div className="tb-full flex items-center gap-3 shrink-0">
              <NotificationBell accentColor="#c85a13" ringColor="#c85a13" />
              {isGuest ? (
                <Link
              ...
              {nav.map(({ icon: Icon, label, href }) => {
                ...
                return guestBlock ? (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-3 rounded-xl text-sm transition-all text-orange-100/70 hover:bg-white/10 hover:text-white"
                  >
                    <Icon size={16} className="text-orange-200/60" />
                    {label}
                  </button>
                ) : (
                  <Link
                  ...
                  >
                    <Icon size={16} className={isActive(href) ? "text-white" : "text-orange-200/60"} />
                    {label}
                  </Link>
                );
              })}
          ...
          <style>{`
            ...
            .meat-scroll::-webkit-scrollbar-track { background: #c85a13; border-radius: 999px; margin: 8px 0 0 0; }
            .meat-scroll::-webkit-scrollbar-thumb { background: #f0a868; border-radius: 999px; border: 5px solid #c85a13; background-clip: padding-box; }
            .meat-scroll::-webkit-scrollbar-thumb:hover { background: #f5c08a; border: 5px solid #c85a13; background-clip: padding-box; }
            .meat-scroll { overflow-y: auto; scrollbar-color: #f0a868 #c85a13; }
          `}</style>
          <div
          ...
          >
            <style>{`
              ...
              .mln-tab.mln-on .mln-icon { background:#fbede2; }
              ...
              .mln-tab.mln-on .mln-lbl { color:#c85a13; font-weight:700; }
            `}</style>
            <div className="mln-bar">
              {nav.map(({ icon: Icon, label, mobileLabel, href }) => {
                ...
                return guestBlock ? (
                  ...
                  >
                    <div className="mln-icon">
                      <Icon size={19} strokeWidth={act ? 2.4 : 1.7} color={act ? "#c85a13" : "#a1a1aa"} />
                    </div>
                    <span className="mln-lbl">{displayLabel}</span>
                  </Link>
                );
