...
import { X, ArrowLeft, Heart, Home as HomeIcon, List, CheckCircle, HelpCircle, FileText, LogOut, User } from "lucide-react-native";
...
const NAV = [
  ...
  { label: "Şərtlərimiz", Icon: FileText, screen: "TermsCollective" },
];

const WIDTH = 260;
const PURPLE = "#301586";

export default function CollectiveSideMenu({ visible, onClose }) {
...
const styles = StyleSheet.create({
  ...
  panel: { position: "absolute", top: 0, left: 0, bottom: 0, width: WIDTH, backgroundColor: PURPLE },
  backBar: {
    height: 30,
    flexDirection: "row",
    alignItems: "center",
  ...
  loginBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#5b21b6", borderRadius: 12, paddingVertical: 11 },
