...
export default function ClientShell({ children }) {
  ...
  useEffect(() => {
    ...
    else if (p.startsWith("/meat")) { statusColor = "#c85a13"; statusDark = false; } // narıncı
  ...
  const isLanding = pathname === "/" || pathname.startsWith("/auth") || pathname.startsWith("/charity") || pathname.startsWith("/qurban") || pathname.startsWith("/order") || pathname.startsWith("/my-orders") || pathname.startsWith("/how-it-works") || pathname.startsWith("/qurban-rules") || pathname.startsWith("/settings") || pathname.startsWith("/about") || pathname.startsWith("/services") || pathname.startsWith("/process") || pathname.startsWith("/contact") || pathname.startsWith("/meat");
  const isHome = false;
